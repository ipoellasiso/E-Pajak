...
class LaporanguuserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Laporan_GU_User.Tampilindekslaporanguuser', $data);
    }
    ...
    public function laporangu(Request $request)
    {
        ...
        if ($request->tampilawaluser) {
            ...
            return view('Laporan_GU_User.Viewisilaporangu',[
                'data' => $data,
