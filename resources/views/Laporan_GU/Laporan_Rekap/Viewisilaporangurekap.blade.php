        ...
        {{-- <div class="page-container"> --}}
            ...
            {{-- ######################### Isi Tampil Pajak LS ########################## --}}
                ...
                <div class="row" border="0" align="center" style="width: 200%">
                    <div class="col-1 text-center" align="center" style="width: 18%; margin-top: 20px;">
                        <td colspan="0" style="width: 5%;"><center><img src="/theme/assets/images/13.png" width="80" height="100"></center></td>
                    </div>
                    <div class="col-6" style="width: 18%; margin-top: 15px; text-align: center; font-size: 17px; font-weight: bold;">
                        <td colspan="6" style="width: 65%;">
