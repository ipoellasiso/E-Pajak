...
<html lang="en">
    ...
    <body style="background-color: white;">
                                        ...
                                        <table border="1" cellpadding="10" align="center" cellspacing="20" id="" class="display table table-bordered" style="width:100%">
                                            ...
                                            {{-- <tfoot> --}}
                                                <tr>
                                                    ...
                                                    <td style="text-align: right"> {{ number_format($total = $cetakpajakls->sum('nilai_pajak'), 0) }}</td>
                                                </tr>
                                            {{-- </tfoot> --}}
                                        </table>
        ...
        <script>
            ...
            setTimeout(() => {
                window.close();
                window.location.href = '/laporanpajakls-cetak';
            }, 1000);
        </script> --}}
