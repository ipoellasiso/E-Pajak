...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="/landing/assets/css/templatemo-edu-meeting.css">
...
<body>
              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li class="scroll-to-section"><a href="#apply">Dokumentasi</a></li>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="owl-service-item owl-carousel">
            ...
            <div class="item">
              <div class="icon">
                <img src="/landing/assets/images/service-icon-01.png" alt="">
              </div>
            ...
            <div class="item">
              <div class="icon">
                <img src="/landing/assets/images/service-icon-02.png" alt="">
              </div>
              <div class="down-content">
                <h4>Best Teachers</h4>
                <p>Suspendisse tempor mauris a sem elementum bibendum. Praesent facilisis massa non vestibulum.</p>
            ...
            <div class="item">
              <div class="icon">
                <img src="/landing/assets/images/service-icon-03.png" alt="">
              </div>
              <div class="down-content">
                <h4>Best Students</h4>
                <p>Suspendisse tempor mauris a sem elementum bibendum. Praesent facilisis massa non vestibulum.</p>
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="meeting-details.html"><img src="/landing/assets/images/meeting-01.jpg" alt="New Lecturer Meeting"></a>
                </div>
                <div class="down-content">
                  <div class="date">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="meeting-details.html"><img src="/landing/assets/images/meeting-02.jpg" alt="Online Teaching"></a>
                </div>
                <div class="down-content">
                  <div class="date">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="meeting-details.html"><img src="/landing/assets/images/meeting-03.jpg" alt="Higher Education"></a>
                </div>
                <div class="down-content">
                  <div class="date">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="meeting-details.html"><img src="/landing/assets/images/meeting-04.jpg" alt="Student Training"></a>
                </div>
                <div class="down-content">
                  <div class="date">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="owl-courses-item owl-carousel">
            <div class="item">
              <img src="/landing/assets/images/course-01.jpg" alt="Course One">
              <div class="down-content">
            ...
            <div class="item">
              <img src="/landing/assets/images/course-02.jpg" alt="Course Two">
              <div class="down-content">
            ...
            <div class="item">
              <img src="/landing/assets/images/course-03.jpg" alt="">
              <div class="down-content">
            ...
            <div class="item">
              <img src="/landing/assets/images/course-04.jpg" alt="">
              <div class="down-content">
            ...
            <div class="item">
              <img src="/landing/assets/images/course-01.jpg" alt="">
              <div class="down-content">
            ...
            <div class="item">
              <img src="/landing/assets/images/course-02.jpg" alt="">
              <div class="down-content">
  ...
  <!-- <section class="our-facts">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center">
          <div class="video">
            <a href="https://www.youtube.com/watch?v=HndV87XpkWg" target="_blank"><img src="/landing/assets/images/play-icon.png" alt=""></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="contact-us" id="contact">
        ...
        <div class="col-lg-3">
          <div class="right-info">
            <ul>
              <li>
                <h6>Phone Number</h6>
                <span>085342157722</span>
              </li>
              <li>
                <h6>Email Address</h6>
                <span>penatausahaa@gmail.com</span>
              </li>
              <li>
                <h6>Street Address</h6>
                <span>Jl. Balaikota No.2</span>
              </li>
              <li>
                <h6>Website URL</h6>
                <span>www.simelajang.com</span>
              </li>
            </ul>
          </div>
        </div>
    ...
    <!-- <div class="footer">
      <p>Copyright © date('Y') Pemetintah Kota Palu., All Rights Reserved. 
          <br>
          Design: <a href="#" target="_parent" title="free css templates">Badan Pengelola Keuangan dan Aset Daerah</a>
          <br>
